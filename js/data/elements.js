...
const TYPE_CHART = {
  ...
  ice:   {weak:['fire','phys'],           resist:['ice','water','grass']},
  light: {weak:['earth','ice'],           resist:['light','water']},
  grass: {weak:['fire','ice','poison'],   resist:['water','earth','light']},
  earth: {weak:['water','grass','ice'],   resist:['light','poison','phys']},
  poison:{weak:['fire','holy'],           resist:['poison','grass','shadow']},
